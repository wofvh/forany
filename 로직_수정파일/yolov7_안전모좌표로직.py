            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or view_img:  # Add bbox to image
                        ...
                        if c == 1 :
                            person = {'xyxy': xyxy, 'conf': conf}
                            # print("object_0:",object_0)
                        elif c == 3 :
                            hat = {'xyxy': xyxy, 'conf': conf}
                            
                if person is not None and hat is not None:
                        
                        print("works")
                        global distance
                        xyxy_0 = person['xyxy']
                        xyxy_1 = hat['xyxy']
                          # object_0와 object_1의 중앙 좌표 계산
                        center_0_y = (xyxy_0[1] + xyxy_0[3]) / 2
                        center_1_y = (xyxy_1[1] + xyxy_1[3]) / 2

                        distance = ((xyxy_0[0] - xyxy_1[0]) ** 2 + (center_0_y - center_1_y) ** 2) ** 0.5
                        ...
                        is_inside = xyxy_1[0] >= xyxy_0[0] and xyxy_1[1] >= xyxy_0[1] and xyxy_1[2] <= xyxy_0[2] and xyxy_1[3] <= xyxy_0[3]
                        if center_1_y < center_0_y and is_inside:
