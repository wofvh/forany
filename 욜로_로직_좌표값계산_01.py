        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                ...
                if object_0 is not None and object_1 is not None:
                    ...
                    # object_1의 위치 판단
                    if center_1_y < center_0_y:
                        print("object_1 is above the center of object_0.")
                    else:
                        print("object_1 is below the center of object_0.")
                else:
                    print("Either object_0 or object_1 was not detected in the image.")
