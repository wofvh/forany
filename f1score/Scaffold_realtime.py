...
def detect_ppe(image, model, timestamp):
    ...
    cv2.putText(image, f"{formatted_datetime} ", (width-200, height-20), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
...
if __name__ == "__main__":
    ...
    ppe_model = torch.hub.load('WongKinYiu/yolov7', 'custom', './best.pt', force_reload=False)
